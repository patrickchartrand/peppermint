<template>
    <article class="py-20 h-full w-full flex items-center group">
        <div class="text-4xl md:text-6xl w-full md:w-11/12">
            <p class="text-amber-50 font-medium m-0 flex gap-2 h-20 md:h-auto leading-none">Hello. <CommonTypewriter :writing="['I\'m a Patrick.', 'I\'m a Javascript enthusiast.', 'I\'m an avid learner.', 'I\'m a digital artisan.']" /></p>
    ...
    <section id="about" class="py-20 h-full flex md:items-center">
        <div>
    ...
    <section id="projects" class="py-20 h-full">
